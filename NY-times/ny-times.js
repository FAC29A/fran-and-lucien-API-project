...
// // Function to create bestsellers categories links on page 1
...
// //(e.g. "?category=hardcover-fiction")
// const urlParams = new URLSearchParams(window.location.search);
// //urlParams.get('category') retrieves the value associated with the "category" key from the query string, 
// //which is "hardcover-fiction" in this example, and assigns it to the category variable.
...
//                 // const pageHeading = document.getElementById('category-title');
//                 // pageHeading.innerHTML = `Current ${category} Bestsellers`
